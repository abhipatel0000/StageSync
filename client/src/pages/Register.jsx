...
export default function Register() {
  ...
  const { user, registerOrganizer, loading } = useAuth();
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await registerOrganizer(fullName, email, password);
    ...
    <div className="flex-1 flex items-center justify-center px-6 py-12 relative">
      ...
      <div className="w-full max-w-md glass-card p-8 rounded-2xl border border-white/5 relative z-10">
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold tracking-tight text-slate-100">Create Organizer Account</h2>
          <p className="text-sm text-slate-400 mt-2">Manage event files and venue access securely</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="glass-input w-full pl-11 pr-4 py-2.5 rounded-xl text-slate-200 text-sm"
